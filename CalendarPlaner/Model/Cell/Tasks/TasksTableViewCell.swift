...
class TasksTableViewCell: UITableViewCell {
    ...
    let taskName = UILabel(text: "Программирование",
                           font: UIFont.avenirNextDemiBold20())
    let taskDescription = UILabel(text: "Научиться писать extension и правильно их применять Научиться писать extension и правильно их применять",
